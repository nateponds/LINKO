...
- **`Branches` Table:** Represents physical fulfillment infrastructure related to the canonical warehouse concept in the _Warehouse Operations_ domain.
- **`Parcels` Table:** Serves as the physical fulfillment manifest tied directly to final _Orders and Fulfillment_ pipelines.
