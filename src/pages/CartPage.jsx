...
export default function CartPage() {
  ...
  function checkoutCart() {
    ...
    setConfirm({
      ...
      message: `Place cash on delivery orders with ${supplierLabel} for ${itemCount} item${itemCount === 1 ? "" : "s"} totalling ${peso(total)} (including ${peso(deliveryFee)} delivery)?`,
      ...
      <div className="cart-page">
        ...
        <section className="cart-checkout" aria-label="Checkout">
          ...
          <button
            ...
            disabled={groups.length === 0 || checkingOut}
